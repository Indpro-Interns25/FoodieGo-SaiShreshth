...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    ...
    final username = (_profile?['restaurant_name'] ?? '') as String? ?? 'Restaurant';
  ...
  List<Widget> _buildDynamicFields() {
    ...
    // Optional: order keys with restaurant_name first
    final keys = _profile!.keys.toList();
    keys.sort((a, b) {
      if (a == 'restaurant_name') return -1;
      if (b == 'restaurant_name') return 1;
